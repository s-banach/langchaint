...
Most examples construct accounts directly to keep request code visible.
`04_failures_and_deadlines.py` coordinates multiple account lifecycles.

| File | Shows |
| --- | --- |
| [`01_basics.py`](01_basics.py) | Account construction, bindings, `Response.call`, structured output, rebinding, and batches |
...
| [`04_failures_and_deadlines.py`](04_failures_and_deadlines.py) | Account request limits, deadlines, batch failures, and provider fallback |
...
| [`09_embeddings.py`](09_embeddings.py) | Retrieval tasks, normalized matrices, and shared `SharedBackoff` construction |
